...
<body class="container-fluid">
    ...
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" name="nom" class="form-control form-control-md" require>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="prenom">Prénom <sup>*</sup> : </label>
                                <input type="text" name="prenom" class="form-control form-control-md " require>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="number" name="age" class="form-control form-control-md " require>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="ville">Ville <sup>*</sup> : </label>
                                <input type="text" name="ville" class="form-control form-control-md " require>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="adresse">Adresse <sup>*</sup> : </label>
                        <input type="text" name="adresse" class="form-control form-control-md " require>
                    </div>
                    <div class="form-group">
                        <label for="email">Email <sup>*</sup> : </label>
                        <input type="email" name="email" class="form-control form-control-md" require>
                    </div>
                    <div class="form-group">
                        <label for="password">Password <sup>*</sup> : </label>
                        <input type="password" name="password" class="form-control form-control-md" require>
                    </div>
                    <div class="form-group">
                        <label for="confirm_password">Confirme Password <sup>*</sup> :</label>
                        <input type="password" name="confirm_password" class="form-control form-control-md " require>
                    </div>
                    <div class="row">
                        <div class="col">
        ...
        <div class="col-md-5 col-sm-11">
            <img src="./images/register.png" height="100%" width="95%" alt="" srcset="">
        </div>
    </div>
